// This webpage(custom.html) presents a pie chart created using canvasJS. The pie chart consists of data regarding TV-episodes of the show "Norge Rundt" from Bergen.
...
// The actual initialization of the Pie Chart. DataList is used as the data in the cart.
function createPieChart() {
  var pieData = {
	animationEnabled: true,
	title: {
		text: "Norge Rundt - Bergen - " + currentChoice + ": " + aar
	},
	data: [{
		type: "pie",
		startAngle: 240,
...
var chart = new CanvasJS.Chart("chartContainer", pieData);
chart.render();
}
    ...
    getJSON(url,function(err, data) {
      if (err !== null) {
        ...
        if(currentChoice === "tema") {
          ...
          createPieData(data, "hovedperson1_kjonn");
        }
        else if(currentChoice === "hovedperson1_alder"){
          createPieData(data, "hovedperson1_alder");
        }
        createPieChart();
      }
    });
